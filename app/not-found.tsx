export default function Example() {
    return (
        <div className="flex flex-col items-center justify-center text-sm max-md:px-4 py-20 lg:py-28 lg:px-0">
            ...
            <div className="flex items-center gap-4 mt-6">
                <a href="/" className="bg-black hover:bg-black px-7 py-2.5 text-white rounded-full active:scale-95 transition-all">
                    Return Home
                </a>
                <a href="#" className="border border-gray-300 px-7 py-2.5 text-gray-800 rounded-full active:scale-95 transition-all">
                    Contact support
                </a>
            </div>
        </div>
